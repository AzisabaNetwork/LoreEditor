...
public class CraftItemStackImpl implements CraftItemStack {
    ...
    public @Nullable ItemStack asNMSCopy(org.bukkit.inventory.@Nullable ItemStack item) {
        return new ItemStackImpl(org.bukkit.craftbukkit.v1_16_R3.inventory.CraftItemStack.asNMSCopy(item));
    }

    @NotNull
    @Override
    public org.bukkit.inventory.ItemStack asCraftMirror(@NotNull ItemStack item) {
        return org.bukkit.craftbukkit.v1_16_R3.inventory.CraftItemStack.asCraftMirror(((ItemStackImpl) item).getHandle());
    }
}
