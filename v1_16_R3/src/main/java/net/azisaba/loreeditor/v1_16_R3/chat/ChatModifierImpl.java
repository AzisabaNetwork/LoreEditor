...
public class ChatModifierImpl implements ChatModifier {
    private final net.minecraft.server.v1_16_R3.ChatModifier handle;

    public ChatModifierImpl(net.minecraft.server.v1_16_R3.ChatModifier handle) {
    ...
    public static @NotNull ChatModifierImpl getInstance(@NotNull Object handle) {
        return new ChatModifierImpl((net.minecraft.server.v1_16_R3.ChatModifier) handle);
    }

    public @NotNull net.minecraft.server.v1_16_R3.ChatModifier getHandle() {
        return handle;
    }
